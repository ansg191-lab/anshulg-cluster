...
variable "hermes_machine_type" {
  description = "Machine type for Hermes instance"
  type        = string
  default     = "e2-medium"
}

variable "hermes_disk_size" {
  description = "Boot disk size for Hermes instance in GB"
  type        = number
  default     = 32
}

variable "hermes_disk_type" {
  description = "Boot disk type for Hermes instance"
  type        = string
  default     = "pd-balanced"
}

variable "hermes_image" {
  description = "OS image for Hermes instance"
  type        = string
  default     = "projects/debian-cloud/global/images/debian-13-trixie-v20260310"
}

variable "hermes_ssh_allowed_ips" {
  description = "IP ranges allowed to SSH to Hermes instance"
  type        = list(string)
  default = [
    "72.219.136.19/32", # Cox ISP
  ]
